...
export function validateAlternativeSemantics(group) {
  ...
  if (/\b(?:organization|company)\s+(?:or|ou)\s+(?:organization|company)\b/iu.test(group.context) && !/\b(?:one of|either|at least one|equivalent experience)\b/iu.test(group.context)) {
