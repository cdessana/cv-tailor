...
function signaledFallback(section, unit) {
  ...
  if (
    ...
    return null;
  // Heading signals are decisive for bullets, not arbitrary prose. Context is
  // common under headings such as "What you'll do" and remains unresolved.
  if (unit.type !== "bullet") return null;
  let candidate;
