    ...
    properties: {
      decisions: {
        ...
        items: {
          ...
          properties: {
            unitId: { type: "string" },
            action: { type: "string", enum: ["exclude", "requirement", "responsibility", "alternative"] },
    ...
    const request = {
      ...
      body: JSON.stringify({
          contents: [{ role: "user", parts: [{ text: [
            ...
            "Return decide_units. requirement requires an explicit required/preferred source heading; alternative requires a clear OR/OU and exact values; otherwise exclude context.",
...
export function createGeminiProvider(options = {}) {
  if (options.decisionMode) return createGeminiDecisionProvider(options);
