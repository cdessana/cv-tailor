    ...
    const request = {
      ...
      body: JSON.stringify({
          contents: [{ role: "user", parts: [{ text: [
            ...
            "Return decide_units. requirement requires an explicit required/preferred source heading; alternative requires a clear OR/OU and exact values; metadata requires an explicit metadataKey and exact source value; otherwise exclude context.",
