    ...
    properties: {
      decisions: {
        ...
        items: {
          ...
          properties: {
            unitId: { type: "string" },
            action: { type: "string", enum: ["exclude", "requirement", "responsibility", "alternative", "metadata"] },
    ...
    const request = {
      ...
      body: JSON.stringify({
          contents: [{ role: "user", parts: [{ text: [
            ...
            "Return decide_units. Use requirement for a source-backed candidate qualification: explicit required/preferred headings retain their strength, while neutral or Activities prose becomes a generic qualification. alternative requires a clear OR/OU and exact values; metadata requires an explicit metadataKey and exact source value; otherwise exclude context.",
