  ...
  properties: {
    decisions: {
      ...
      items: {
        ...
        properties: {
          unitId: { type: "string" },
          action: { enum: ["exclude", "requirement", "responsibility", "alternative", "metadata"] },
...
function decisionPrompt(blocks) {
  return [
    ...
    "Actions: exclude for context; requirement for a source-backed candidate qualification. Under an explicit required/preferred heading the application preserves that strength; in neutral or Activities prose it preserves a generic qualification without inventing required/preferred strength. responsibility is only for duties; alternative is only for a clear explicit OR/OU choice and includes exact option values; metadata is only for an explicit metadata value and includes metadataKey plus its exact source value.",
