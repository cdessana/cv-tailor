...
function decisionPrompt(blocks) {
  return [
    ...
    "Actions: exclude for context; requirement only for candidate qualifications beneath an explicit required/preferred heading; responsibility only for duties; alternative only for a clear explicit OR/OU choice and include the exact option values; metadata only for an explicit metadata value and include metadataKey plus its exact source value.",
