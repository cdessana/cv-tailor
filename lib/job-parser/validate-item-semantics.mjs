...
const broadCategoryOr = /\b(?:platforms?|frameworks?|tools?|languages?|technologies|systems|solutions|methods|approaches)\s+(?:or|ou)\s+(?:(?:connector|backend|frontend|integration|cloud|data|automation)\s+)?(?:platforms?|frameworks?|tools?|languages?|technologies|systems|solutions|methods|approaches)\b/iu;
