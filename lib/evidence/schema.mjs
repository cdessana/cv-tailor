...
export const INTERNAL_SOURCE_TYPES = new Set(["json_resume", "questionnaire"]);
export const EXTERNAL_SUPPORTING_SOURCE_TYPES = new Set(["linkedin", "github", "feedback", "manual"]);
export const SOURCE_TYPES = new Set([...INTERNAL_SOURCE_TYPES, ...EXTERNAL_SUPPORTING_SOURCE_TYPES]);
...
export function assertEvidenceCandidate(candidate) {
  ...
  if (!Number.isSafeInteger(candidate.revision) || candidate.revision < 0) fail("candidate.revision", "must be a non-negative integer");
